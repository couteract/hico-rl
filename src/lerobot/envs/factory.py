...
def make_env_pre_post_processors(
    ...
    # XVLA is an optional policy package and is not part of every LeRobot
    # checkout. Detect it by config type so unrelated policies such as SmolVLA
    # can build environments without importing an unavailable XVLA module.
